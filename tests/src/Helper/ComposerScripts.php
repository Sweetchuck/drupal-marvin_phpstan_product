...
class ComposerScripts {
  ...
  protected string $projectNameSnake = 'marvin_phpstan_product';

  protected string $projectNameDash = 'marvin-phpstan-product';
          ...
          'drush' => [
            'paths' => [
              'config' => [
                ...
                "\${drush.vendor-dir}/../{$this->projectRoot}/drush/Commands/contrib/marvin_phpstan/Commands/drush.yml",
              ...
              'include' => [
                ...
                "\${drush.vendor-dir}/../{$this->projectRoot}/drush/Commands/contrib/marvin_phpstan",
